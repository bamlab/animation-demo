    ...
    return (
      <View style={{ flex: 1 }}>
        ...
        <HeaderImageScrollView
          ...
          fadeOutForeground
          renderHeader={() => (
            <Image source={{uri: `https://image.tmdb.org/t/p/w500/${tvShowContent.backdrop_path}`}} style={styles.image} />
          )}
          renderFixedForeground={() => (
            ...
            >
              <Text style={styles.navTitle}>{tvShowContent.name}</Text>
            </Animatable.View>
          )}
          renderForeground={() => (
          ...
          >
            <Text style={styles.title}>
              <Text style={styles.name}>{tvShowContent.name}</Text>
            </Text>
          </TriggeringView>
